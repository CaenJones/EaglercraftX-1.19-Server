...
curl -O https://github.com/CaenJones/EaglercraftX-1.19-Server/blob/main/testing/windows/run.bat
...
if /I "%startServer%"=="y" (
    ...
    echo Use run.bat in your downloads folder to start the server!
